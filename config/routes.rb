Rails.application.routes.draw do
  ...
  get "patient"  => "patients#new", 
    as: :new_patient
  get "patient/:id/edit" => "patients#edit",
    as: :edit_patient
  get "patients/main/:limit/:offset" => "patients#main",
    as: :main_patients
  get "patients/amount" => "patients#amount",
    as: :amount_patients
  get "allpatients/:resource" => "patients#allpatients",
    as: :patients_allpatients 
  ...
  get "consults" => "consults#agenda",
    as: :agenda_consults
  get "consults/allpatients/:resouce" => "patients#allpatients", 
  ...
  get "insurances" => "insurances#index", 
    as: :index_insurances
  get "insurance"  => "insurances#new", 
    as: :new_insurance
  get "insurance/:id/edit" => "insurances#edit", 
    as: :edit_insurance
  get "insurances/main/:limit/:offset" => "insurances#main", 
    as: :main_insurances
  get "insurances/amount" => "insurances#amount", 
    as: :amount_insurances
  get "allinsurances" => "insurances#allinsurances", 
    as: :all_insurances
